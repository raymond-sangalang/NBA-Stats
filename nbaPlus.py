...
from nameScrape import Name, getTeam
...
def save_object(_obj, filename):
    ...
    with open(filename, 'wb') as outFile:
        pickle.dump(_obj, outFile, protocol=pickle.HIGHEST_PROTOCOL)
...
class UI:
    ...
    def getData(self):
        return self.playerBase  # getter to the database
